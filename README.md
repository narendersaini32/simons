...
The wireframes developed for this project was only taken three types of devices, desktop, tablet and mobile. In addition, the tool used to develop this wireframes was Balsamiq giving the ability to a rapid design.
    ...
    - [Mobile devices](interactive-frontend-project/assets/images/wireframes/simons_mobile.png)
    - [Tablet devices](interactive-frontend-project/assets/images/wireframes/simons_tablet.png)
    - [Desktop devices](interactive-frontend-project/assets/images/wireframes/simons_desktop.png)
